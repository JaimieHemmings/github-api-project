    ...
    <section className="relative overflow-hidden mx-auto">
      ...
      <div className="relative container mx-auto">
        ...
        <div className="md:-space-x-26 container relative flex flex-col items-start md:flex-row md:items-center">
          <div className="z-20 -mx-[calc(theme(container.padding))] w-[calc(100%+2*theme(container.padding))] shrink-0 bg-background px-[calc(theme(container.padding))] md:pt-32 md:w-1/2 md:bg-transparent md:pb-32">
            <div className="flex flex-col items-start text-left p-5">
              <div className="max-w-sm">
                <h1 className="my-6 text-pretty text-4xl lg:text-6xl">
                  Welcome to <span className="font-bold">GithubRef</span>
                </h1>
                <p className="py-2 text-pretty">
                  GithubRef is a project developed to explore the Github API and its features. It is a simple project that allows you to search for users and repositories on Github.
                </p>
                <Link to="/about">
                  <Button>About</Button>
                </Link>
